# MVP-ML-ANALYTICS-CLARA-BASTOS
Repositório criado para o desenvolvimento do trabalho MVP da sprint Machine Learning - Analytics do curso de pós graduação de Ciência de Dados e Analytics da PUC-Rio
...
\`\`\`python
import joblib
modelo = joblib.load("Modelo/modelo_final_clara_bastos.pkl")
\`\`\`
